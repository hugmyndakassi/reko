...
Instr(InstrClass.Padding|InstrClass.Zero, Mnemonic.brk),
    ...
    invalid,
            ...
            // 10
Instr(InstrClass.CondJump, Mnemonic.bpl, j),
    ...
    invalid,
            // 20
Instr(InstrClass.Call, Mnemonic.jsr, A),
    ...
    invalid,
        // 30
Instr(InstrClass.CondJump, Mnemonic.bmi, j),
    ...
    invalid,
 // 40
Instr(InstrClass.Return, Mnemonic.rti),
    ...
    invalid,
    Instr(InstrClass.Jump, Mnemonic.jmp, A),
    Instr(Mnemonic.eor, A),
    Instr(Mnemonic.lsr, A),
    invalid,
 // 50
Instr(InstrClass.CondJump, Mnemonic.bvc, j),
    ...
    invalid,
 	// 60
Instr(InstrClass.Return, Mnemonic.rts),
    ...
    invalid,
    Instr(InstrClass.JumpInd, Mnemonic.jmp, i),	
    Instr(Mnemonic.adc, A),
    Instr(Mnemonic.ror, A),
    invalid,
 	// 70
Instr(InstrClass.CondJump, Mnemonic.bvs, j),
...
invalid,
    ...
    invalid,
 	// 90
Instr(InstrClass.CondJump, Mnemonic.bcc, j),
...
Instr(Mnemonic.ldy, Imm),
    ...
    invalid,
 	// B0
Instr(InstrClass.CondJump, Mnemonic.bcs, j),
    ...
    Instr(Mnemonic.cpy, Imm),
        ...
        // D0
        Instr(InstrClass.CondJump, Mnemonic.bne, j),
        ...
        // F0
        Instr(InstrClass.CondJump, Mnemonic.beq, j),
