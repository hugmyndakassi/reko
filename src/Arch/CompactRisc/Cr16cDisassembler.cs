    ...
    public class Cr16cDisassembler : DisassemblerBase<Cr16Instruction, Mnemonic>
    {
        ...
        static Cr16cDisassembler()
        {
            ...
            var decode000 = Mask(0, 4, "  000",
                ...
                param0(Mnemonic.res, InstrClass.Invalid),
                param0(Mnemonic.res, InstrClass.Invalid),
                param0(Mnemonic.retx, InstrClass.Return),
            ...
            var decode0010 = Mask(12, 4, "  0010",
                Mask(4, 4, "  b?? disp24",
                    Instr(Mnemonic.beq, InstrClass.CondJump, edisp24),
                    Instr(Mnemonic.bne, InstrClass.CondJump, edisp24),
                    Instr(Mnemonic.bcs, InstrClass.CondJump, edisp24),
                    Instr(Mnemonic.bcc, InstrClass.CondJump, edisp24),
                    Instr(Mnemonic.bhi, InstrClass.CondJump, edisp24),
                    Instr(Mnemonic.bls, InstrClass.CondJump, edisp24),
                    Instr(Mnemonic.bgt, InstrClass.CondJump, edisp24),
                    Instr(Mnemonic.ble, InstrClass.CondJump, edisp24),
                    Instr(Mnemonic.bfs, InstrClass.CondJump, edisp24),
                    Instr(Mnemonic.bfc, InstrClass.CondJump, edisp24),
                    Instr(Mnemonic.blo, InstrClass.CondJump, edisp24),
                    Instr(Mnemonic.bhs, InstrClass.CondJump, edisp24),
                    Instr(Mnemonic.blt, InstrClass.CondJump, edisp24),
                    Instr(Mnemonic.bge, InstrClass.CondJump, edisp24),
                    Instr(Mnemonic.br , InstrClass.CondJump, edisp24),
                    Instr(Mnemonic.br,  InstrClass.CondJump, edisp24)),
            ...
            var decode00 = Mask(4, 4, "  00",
                ...
                Instr(Mnemonic.jal, InstrClass.Call, RA, rp0),
                invalid,
                invalid);
            var decode0 = Mask(8, 4,
                ...
                Mask(4, 4, "  0A",
                    Instr(Mnemonic.jeq, InstrClass.CondJump, rp0),
                    Instr(Mnemonic.jne, InstrClass.CondJump, rp0),
                    Instr(Mnemonic.jcs, InstrClass.CondJump, rp0),
                    Instr(Mnemonic.jcc, InstrClass.CondJump, rp0),
                    Instr(Mnemonic.jhi, InstrClass.CondJump, rp0),
                    Instr(Mnemonic.jls, InstrClass.CondJump, rp0),
                    Instr(Mnemonic.jgt, InstrClass.CondJump, rp0),
                    Instr(Mnemonic.jle, InstrClass.CondJump, rp0),
                    Instr(Mnemonic.jfs, InstrClass.CondJump, rp0),
                    Instr(Mnemonic.jfc, InstrClass.CondJump, rp0),
                    Instr(Mnemonic.jlo, InstrClass.CondJump, rp0),
                    Instr(Mnemonic.jhs, InstrClass.CondJump, rp0),
                    Instr(Mnemonic.jlt, InstrClass.CondJump, rp0),
                    Instr(Mnemonic.jge, InstrClass.CondJump, rp0),
                    Instr(Mnemonic.jr, InstrClass.CondJump, rp0),
                    Instr(Mnemonic.jr, InstrClass.CondJump, rp0)),
            ...
            var decodeC = Mask(8, 4, "  C",
                Instr(Mnemonic.bal, InstrClass.Call, RA, disp24),
            ...
            rootDecoder = Mask(12, 4, "CR16C",
                ...
                Select(u => (u & 0xF0F) == 0x800,
                    Mask(4, 4, " br disp16",
                        ...
                        Instr(Mnemonic.bfs, InstrClass.CondJump, disp16),
                        Instr(Mnemonic.bfc, InstrClass.CondJump, disp16),
                        Instr(Mnemonic.blo, InstrClass.CondJump, disp16),
                        Instr(Mnemonic.bhs, InstrClass.CondJump, disp16),
                        Instr(Mnemonic.blt, InstrClass.CondJump, disp16),
                        Instr(Mnemonic.bge, InstrClass.CondJump, disp16),
                        Instr(Mnemonic.br, InstrClass.Jump, disp16),
                        Instr(Mnemonic.br, InstrClass.Jump, disp16)),
                    Mask(4, 4, "  1xxx",
                        ...
                        Instr(Mnemonic.bfs, InstrClass.CondJump, disp8),
                        Instr(Mnemonic.bfc, InstrClass.CondJump, disp8),
                        Instr(Mnemonic.blo, InstrClass.CondJump, disp8),
                        Instr(Mnemonic.bhs, InstrClass.CondJump, disp8),
                        Instr(Mnemonic.blt, InstrClass.CondJump, disp8),
                        Instr(Mnemonic.bge, InstrClass.CondJump, disp8),
                        Instr(Mnemonic.br, InstrClass.Jump, disp8),
                        Instr(Mnemonic.br, InstrClass.Jump, disp8))),
                decode2,
                decode3,
