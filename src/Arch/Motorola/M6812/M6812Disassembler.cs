    ...
    public class M6812Disassembler : DisassemblerBase<M6812Instruction, Mnemonic>
    {
        ...
        static M6812Disassembler()
        {
            ...
            decodersSecondByte = new Decoder[256]
            {
                ...
                // 20
                Instr(Mnemonic.lbra, InstrClass.Jump, QR),
                Instr(Mnemonic.lbrn, QR),
                Instr(Mnemonic.lbhi, InstrClass.CondJump, QR),
                Instr(Mnemonic.lbls, InstrClass.CondJump, QR),

                Instr(Mnemonic.lbcc, InstrClass.CondJump, QR),
                Instr(Mnemonic.lbcs, InstrClass.CondJump, QR),
                Instr(Mnemonic.lbne, InstrClass.CondJump, QR),
                Instr(Mnemonic.lbeq, InstrClass.CondJump, QR),

                Instr(Mnemonic.lbvc, InstrClass.CondJump, QR),
                Instr(Mnemonic.lbvs, InstrClass.CondJump, QR),
                Instr(Mnemonic.lbpl, InstrClass.CondJump, QR),
                Instr(Mnemonic.lbmi, InstrClass.CondJump, QR),

                Instr(Mnemonic.lbge, InstrClass.CondJump, QR),
                Instr(Mnemonic.lblt, InstrClass.CondJump, QR),
                Instr(Mnemonic.lbgt, InstrClass.CondJump, QR),
                Instr(Mnemonic.lble, InstrClass.CondJump, QR),
                // 30
                Instr(Mnemonic.trap),
                Instr(Mnemonic.trap),
                Instr(Mnemonic.trap),
            ...
            {
                // 00 
                Instr(Mnemonic.dbeq, InstrClass.CondJump, A, RPlus),
                Instr(Mnemonic.dbeq, InstrClass.CondJump, B, RPlus),
                Instr(Mnemonic.trap),
                Instr(Mnemonic.trap),

                Instr(Mnemonic.dbeq, InstrClass.CondJump, D, RPlus),
                Instr(Mnemonic.dbeq, InstrClass.CondJump, X, RPlus),
                Instr(Mnemonic.dbeq, InstrClass.CondJump, Y, RPlus),
                Instr(Mnemonic.dbeq, InstrClass.CondJump, S, RPlus),
                ...
                Instr(Mnemonic.dbeq, InstrClass.CondJump, S, RPlus),
                // 10 
                Instr(Mnemonic.dbeq, InstrClass.CondJump, A, RMinus),
                Instr(Mnemonic.dbeq, InstrClass.CondJump, B, RMinus),
                Instr(Mnemonic.trap),
                Instr(Mnemonic.trap),

                Instr(Mnemonic.dbeq, InstrClass.CondJump, D, RMinus),
                Instr(Mnemonic.dbeq, InstrClass.CondJump, X, RMinus),
                Instr(Mnemonic.dbeq, InstrClass.CondJump, Y, RMinus),
                Instr(Mnemonic.dbeq, InstrClass.CondJump, S, RMinus),
                ...
                Instr(Mnemonic.dbeq, InstrClass.CondJump, S, RMinus),
                // 20 
                Instr(Mnemonic.dbne, InstrClass.CondJump, A, RPlus),
                Instr(Mnemonic.dbne, InstrClass.CondJump, B, RPlus),
                Instr(Mnemonic.trap),
                Instr(Mnemonic.trap),

                Instr(Mnemonic.dbne, InstrClass.CondJump, D, RPlus),
                Instr(Mnemonic.dbne, InstrClass.CondJump, X, RPlus),
                Instr(Mnemonic.dbne, InstrClass.CondJump, Y, RPlus),
                Instr(Mnemonic.dbne, InstrClass.CondJump, S, RPlus),
                ...
                Instr(Mnemonic.dbne, InstrClass.CondJump, S, RPlus),
                // 30 
                Instr(Mnemonic.dbne, InstrClass.CondJump, A, RMinus),
                Instr(Mnemonic.dbne, InstrClass.CondJump, B, RMinus),
                Instr(Mnemonic.trap),
                Instr(Mnemonic.trap),

                Instr(Mnemonic.dbne, InstrClass.CondJump, D, RMinus),
                Instr(Mnemonic.dbne, InstrClass.CondJump, X, RMinus),
                Instr(Mnemonic.dbne, InstrClass.CondJump, Y, RMinus),
                Instr(Mnemonic.dbne, InstrClass.CondJump, S, RMinus),
                ...
                Instr(Mnemonic.dbne, InstrClass.CondJump, S, RMinus),
                // 40 
                Instr(Mnemonic.tbeq, InstrClass.CondJump, A, RPlus),
                Instr(Mnemonic.tbeq, InstrClass.CondJump, B, RPlus),
                Instr(Mnemonic.trap),
                Instr(Mnemonic.trap),
                ...
                Instr(Mnemonic.tbne, S, RMinus),
                // 80 
                Instr(Mnemonic.ibeq, InstrClass.CondJump, A, RPlus),
                Instr(Mnemonic.ibeq, InstrClass.CondJump, B, RPlus),
                Instr(Mnemonic.trap),
                Instr(Mnemonic.trap),
            ...
            decoders = new Decoder[256]
            {
                ...
                Instr(Mnemonic.jmp, InstrClass.Jump, XB),
                Instr(Mnemonic.jmp, InstrClass.Jump, HL),
                Instr(Mnemonic.bsr, InstrClass.Call, R),

                Instr(Mnemonic.inx),
                Instr(Mnemonic.dex),
                Instr(Mnemonic.rtc, InstrClass.Return),
                ...
                Instr(Mnemonic.jsr, InstrClass.CallInd, XB),
                Instr(Mnemonic.jsr, InstrClass.CallInd, HL),
                Instr(Mnemonic.jsr, InstrClass.Call, Dir),
                ...
                // 20
                Instr(Mnemonic.bra, InstrClass.Jump, R),
                Instr(Mnemonic.brn, R),
                Instr(Mnemonic.bhi, InstrClass.CondJump, R),
                Instr(Mnemonic.bls, InstrClass.CondJump, R),

                Instr(Mnemonic.bcc, InstrClass.CondJump, R),
                Instr(Mnemonic.bcs, InstrClass.CondJump, R),
                Instr(Mnemonic.bne, InstrClass.CondJump, R),
                Instr(Mnemonic.beq, InstrClass.CondJump, R),

                Instr(Mnemonic.bvc, InstrClass.CondJump, R),
                Instr(Mnemonic.bvs, InstrClass.CondJump, R),
                Instr(Mnemonic.bpl, InstrClass.CondJump, R),
                Instr(Mnemonic.bmi, InstrClass.CondJump, R),

                Instr(Mnemonic.bge, InstrClass.CondJump, R),
                Instr(Mnemonic.blt, InstrClass.CondJump, R),
                Instr(Mnemonic.bgt, InstrClass.CondJump, R),
                Instr(Mnemonic.ble, InstrClass.CondJump, R),
                // 30
                Instr(Mnemonic.pulx),
                Instr(Mnemonic.puly),
                Instr(Mnemonic.pula),
                ...
                Instr(Mnemonic.lsla),
                Instr(Mnemonic.lsrd),
                Instr(Mnemonic.call, InstrClass.Call, HL,PG),
                Instr(Mnemonic.call, InstrClass.Call, XB_PG),

                Instr(Mnemonic.bset, Dir,I),
                Instr(Mnemonic.bclr, Dir,I),
                Instr(Mnemonic.brset, InstrClass.CondJump, Dir, I, R),
                Instr(Mnemonic.brclr, InstrClass.CondJump, Dir, I, R),
                // 50
                Instr(Mnemonic.negb),
                Instr(Mnemonic.comb),
                Instr(Mnemonic.incb),
