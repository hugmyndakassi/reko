        ...
        static TriCoreDisassembler()
        {
            ...
            rootDecoder = Sparse(0, 8, "TriCore", Instr32(nyi),
                (0x00, Sparse(12, 4, "  0x00", nyi,
                    ...
                    (0x7, Instr(Mnemonic.fret, InstrClass.Return)),
                    (0x8, Instr(Mnemonic.rfe, InstrClass.Return)),
                    (0x9, Instr(Mnemonic.ret, InstrClass.Return)),
                ...
                (0x0D, Instr32(Sparse(22, 6, "  0x0D", nyi,
                    ...
                    (0x03, Instr(Mnemonic.fret, InstrClass.Return)),
                    (0x04, Instr(Mnemonic.debug)),
                    (0x05, Instr(Mnemonic.rfm, InstrClass.Return | InstrClass.Privileged)),
                    (0x06, Instr(Mnemonic.ret, InstrClass.Return)),
                    (0x07, Instr(Mnemonic.rfe, InstrClass.Return)),
                ...
                (0x0E, Instr(Mnemonic.jltz, InstrClass.CondJump, D12, udisp8_4)),
                ...
                (0x1C, invalid),
                (0x1D, Instr32(Instr(Mnemonic.j, InstrClass.Jump, B))),
                (0x1E, invalid),
                (0x1F, invalid),
                ...
                (0x2D, Instr32(Sparse(20, 8, "  0x2D", nyi,
                    (0x00, Instr(Mnemonic.calli, InstrClass.Call | InstrClass.Indirect, A8)),
                    (0x02, Instr(Mnemonic.jli, InstrClass.Call | InstrClass.Indirect, A8)),
                    (0x31, invalid)))),
                (0x2E, Instr(Mnemonic.jz_t, InstrClass.CondJump, d15, uimm12_4, udisp8_4)),
                ...
                (0x3C, Instr(Mnemonic.j, InstrClass.Jump, sdisp8_8)),
                (0x3E, invalid),
                (0x3F, invalid),
                ...
                (0x4E, Instr(Mnemonic.jgtz, InstrClass.CondJump, D12, udisp8_4)),
                ...
                (0x5B, invalid),
                (0x5C, Instr(Mnemonic.call, InstrClass.Call, sdisp8_8)),
                (0x5D, Instr32(Instr(Mnemonic.jl, InstrClass.Call, B))),
                (0x5E, Instr(Mnemonic.jne, InstrClass.CondJump, d15, simm12_4, udisp8_4)),
                (0x5F, Instr32(Mask(31, 1, "  0x5F",
                    Instr(Mnemonic.jeq, InstrClass.CondJump, D8, D12, sdisp16_15),
                    Instr(Mnemonic.jne, InstrClass.CondJump, D8, D12, sdisp16_15)))),
                ...
                (0x6D, Instr32(Instr(Mnemonic.call, InstrClass.Call, B))),
                (0x6E, Instr(Mnemonic.jz, InstrClass.CondJump, d15, sdisp8_8)),
                (0x6F, Instr32(Mask(31, 1, "  0x6F",
                    Instr(Mnemonic.jz_t, InstrClass.CondJump, D8, u8_7_1_12_4, sdisp16_15),
                    Instr(Mnemonic.jnz_t, InstrClass.CondJump, D8, u8_7_1_12_4, sdisp16_15)))),

                (0x70, invalid),
                (0x74, Instr(Mnemonic.st_w, Mw_12, D8)),
                (0x75, invalid),
                (0x76, Instr(Mnemonic.jz, InstrClass.CondJump, D12, udisp8_4)),
                ...
                (0x7C, Instr(Mnemonic.jnz_a, InstrClass.CondJump, A12, udisp8_4)),
                (0x7D, Instr32(Mask(31, 1, "  0x7D",
                    Instr(Mnemonic.jeq_a, InstrClass.CondJump, A8, A12, sdisp16_15),
                    Instr(Mnemonic.jne_a, InstrClass.CondJump, A8, A12, sdisp16_15)))),
                (0x7E, Instr(Mnemonic.jne, InstrClass.CondJump, d15, D8, udisp8_4)),
                (0x7F, Instr32(Mask(31, 1, "  0x7F",
                    Instr(Mnemonic.jge, InstrClass.CondJump, D8, D12, sdisp16_15),
                    Instr(Mnemonic.jge_u, InstrClass.CondJump, D8, D12, sdisp16_15)))),
                ...
                (0xAE, Instr(Mnemonic.jnz_t, InstrClass.CondJump, d15, uimm12_4, udisp8_4)),
                (0xAF, invalid),
                ...
                (0xBC, Instr(Mnemonic.jz_a, InstrClass.CondJump, A12, udisp8_4)),
                (0xBE, Instr(Mnemonic.jeq, InstrClass.CondJump, d15, D12, udisp8_4)),
                (0xBF, Instr32(Mask(31, 1, "  0xBF",
                    Instr(Mnemonic.jlt, InstrClass.CondJump, D8, simm12_4, sdisp16_15),
                    Instr(Mnemonic.jlt_u, InstrClass.CondJump, D8, simm12_4, sdisp16_15)))),
                ...
                (0xCE, Instr(Mnemonic.jgez, InstrClass.CondJump, D12, udisp8_4)),
                (0xCF, invalid),
                ...
                (0xDC, If(12, 4, u => u == 0,
                    Instr(Mnemonic.ji, InstrClass.JumpInd, A8))),
                (0xDF, Instr32(Mask(31, 1, "  0xDF",
                    Instr(Mnemonic.jeq, InstrClass.CondJump, D8, simm12_4, sdisp16_15),
                    Instr(Mnemonic.jne, InstrClass.CondJump, D8, simm12_4, sdisp16_15)))),

                (0xE0, Instr(Mnemonic.bisr, LinPri, D8, uimm8_8)),
                (0xE1, Instr32(Instr(Mnemonic.fcalla, InstrClass.Call, B))),
                ...
                (0xEE, Instr(Mnemonic.jnz, InstrClass.CondJump, d15, sdisp8_8)),
                (0xEF, invalid),
                ...
                (0xF6, Instr(Mnemonic.jnz, InstrClass.CondJump, D12, udisp8_4)),
                (0xFC, Instr(Mnemonic.loop, InstrClass.CondJump, D12, ndisp8_4)),
                ...
                (0xFD, Instr32(Mask(31, 1, "  0xFD",
                    Instr(Mnemonic.loop, InstrClass.CondJump, A12, sdisp16_15),
                    invalid))),
                (0xFE, Instr(Mnemonic.jne, InstrClass.CondJump, d15, D12, udisp8_4_plus16)),
                (0xFF, Instr32(Mask(31, 1, "  0xFF",
                    Instr(Mnemonic.jge, InstrClass.CondJump, D8, simm12_4, sdisp16_15),
                    Instr(Mnemonic.jge_u, InstrClass.CondJump, D8, simm12_4, sdisp16_15)))));
        }
    }
}