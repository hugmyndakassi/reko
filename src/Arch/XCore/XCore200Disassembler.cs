            ...
            rootDecoder = Mask(11, 5, "XCore",
                ...
                Mask(4, 1, "  04",
                    Select((5, 6), u => u == 0x3F, "  04 - 0 0x3F",
                        Instr(Mnemonic.bla, InstrClass.Call, r1),
                        Nyi("04 - 0")),
                    Select((5, 6), u => u == 0x3F, "  04 - 1 0x3F",
                        Instr(Mnemonic.bau, InstrClass.Jump, r1),
                ...
                Select((10, 1), u => u == 0, "  0E",
                    Sparse(6, 4, "  0E_0",
                        Instr(Mnemonic.brft, InstrClass.CondJump, ru6_p_pc),
                        (0xC, Instr(Mnemonic.brfu, InstrClass.Jump, u6_p_pc)),
                        (0xD, Instr(Mnemonic.blat, InstrClass.Call, u6)),
                        (0xE, Instr(Mnemonic.extdp, u6)),
                        (0xF, Instr(Mnemonic.kcalli, InstrClass.Call, u6))),
                    Sparse(6, 4, "  0E_1",
                        Instr(Mnemonic.brbt, InstrClass.CondJump, ru6_m_pc),
                        (0xC, Instr(Mnemonic.brbu, InstrClass.Jump, u6_m_pc)),
                        (0xD, Instr(Mnemonic.entsp, u6)),
                        (0xE, Instr(Mnemonic.extsp, u6)),
                        (0xF, Instr(Mnemonic.retsp, InstrClass.Return, u6)))),
                Select((10, 1), u => u == 0, "  0F",
                    Sparse(6, 4, "  0F_0", 
                        Instr(Mnemonic.brff, InstrClass.CondJump, ru6_p_pc),
                        (0xC, Instr(Mnemonic.clrsr, u6)),
                        (0xD, Instr(Mnemonic.setsr, u6)),
                        (0xE, Instr(Mnemonic.kentsp, u6)),
                        (0xF, Nyi("0F_0 F"))),
                    Sparse(6, 4, "  0F_0",
                        Instr(Mnemonic.brbf, InstrClass.CondJump, ru6_m_pc),
                ...
                Mask(10, 1, "  1A",
                    Instr(Mnemonic.blrf, InstrClass.Call, u10_p_pc),
                    Instr(Mnemonic.blrb, InstrClass.Call, u10_m_pc)),
                Mask(10, 1, "  1B",
                    Instr(Mnemonic.ldapb, PcRel11_2),
                    Instr(Mnemonic.ldapf, PcRel11_2)),

                Mask(10, 1, "  1C",
                    Instr(Mnemonic.blacp, InstrClass.Call, u10),
