    ...
    public class CSkyDisassembler : DisassemblerBase<CSkyInstruction, Mnemonic>
    {
        ...
        static CSkyDisassembler()
        {
            ...
            var bitop_16 = Mask(5, 3, "  bitop",
                ...
                Mask(2, 3,
                    Instr(Mnemonic.jmpix, InstrClass.Jump, r8_3, jmpix2),
                    nyi,
                    nyi,
                    nyi,
            ...
            var decoder00 = Mask(10, 4, "  16-bit 00",
                ...
                Instr(Mnemonic.br, InstrClass.Jump, pcdisp10),
                Instr(Mnemonic.bt, InstrClass.CondJump, pcdisp10),
                Instr(Mnemonic.bf, InstrClass.CondJump, pcdisp10),
                ...
                Mask(5, 3, "  5..3",
                    ...
                    Mask(0, 2, "  0..2",
                        ...
                        Sparse(2, 3, "  ...01", nyi,
                            (0, Instr(Mnemonic.nir, InstrClass.Privileged | InstrClass.Return))),
                        Instr(Mnemonic.ipush),
                        Instr(Mnemonic.ipop)),

                    Instr(Mnemonic.pop, InstrClass.Return, PushPopArgs),
                    Mask(0, 2, "  0..2",
            ...
            var decoder01 = Mask(10, 4, "  16-bit 01",
                ...
                Mask(0, 2, "  1110",
                    Instr(Mnemonic.jmp, InstrClass.Jump, r2),
                    Instr(Mnemonic.jsr, InstrClass.Call, r2),
            ...
            var decoder11 = Mask(26, 4, "  11",
                Sparse(10, 6, "  0000", nyi,
                    ...
                    (0x08, Sparse(5, 5, "  001000", nyi,
                        (0x01, Instr(Mnemonic.trap, InstrClass.Call, uimm10_2)))),
                    ...
                    (0x10, Sparse(5, 5, "  010000", nyi,
                        (0x01, Instr(Mnemonic.rte, InstrClass.Privileged | InstrClass.Return)))),
                    (0x11, Sparse(5, 5, "  010001", nyi,
                        (0x01, Instr(Mnemonic.rfi, InstrClass.Privileged | InstrClass.Return)))),
                    ...
                    (0x1F, Sparse(5, 5, "  0110000", nyi,
                        (0x01, Instr(Mnemonic.srte, InstrClass.Privileged | InstrClass.Return))))),
                ...
                Instr(Mnemonic.bsr, InstrClass.Call, pcdisp26),
                decoder11_1001,
                Sparse(21, 5, "  1010", nyi,
                    (0x00, Instr(Mnemonic.br, InstrClass.Jump, pcdisp16_1)),
                    (0x02, Instr(Mnemonic.bf, InstrClass.CondJump, pcdisp16_1)),
                    (0x03, Instr(Mnemonic.bt, InstrClass.CondJump, pcdisp16_1)),
                    (0x06, If(u => (u & 0xFFFFu) == 0,
                        Instr(Mnemonic.jmp, InstrClass.Jump, R16))),
                    (0x07, If(u => (u & 0xFFFFu) == 0,
                        Instr(Mnemonic.jsr, InstrClass.Call, R16))),
                    (0x08, Instr(Mnemonic.bez, InstrClass.CondJump, R16, pcdisp16_1)),
                    (0x09, Instr(Mnemonic.bnez, InstrClass.CondJump, R16, pcdisp16_1)),
                    (0x0A, Instr(Mnemonic.bhz, InstrClass.CondJump, R16, pcdisp16_1)),
                    (0x0B, Instr(Mnemonic.blsz, InstrClass.CondJump, R16, pcdisp16_1)),
                    (0x0C, Instr(Mnemonic.blz, InstrClass.CondJump, R16, pcdisp16_1)),
                    (0x0D, Instr(Mnemonic.bhsz, InstrClass.CondJump, R16, pcdisp16_1)),
                    (0x0F, If(u => (u & 0xFFFC) == 0,
                        Instr(Mnemonic.jmpix, InstrClass.Jump, R16, jmpix2))),
                    (0x10, Instr(Mnemonic.movi, R16, uimm16)),
                    (0x11, Instr(Mnemonic.movih, R16, uimm16)),
                    (0x14, Instr(Mnemonic.lrw, R16, Mpc_offs16)),
                    (0x16, Instr(Mnemonic.jmpi, InstrClass.Jump, pcdisp16_1)),
                    (0x17, Instr(Mnemonic.jsri, InstrClass.Call, pcdisp16_1)),
