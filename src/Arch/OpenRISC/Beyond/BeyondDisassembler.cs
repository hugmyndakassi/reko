    ...
    static BeyondDisassembler()
    {
        ...
        rootDecoder = WideSparse(10, 6, "BA2 Beyond", nyi,
            ...
            (0b010000, Widen24(WideMask(16, 2, "  010000",
                Instr(Mnemonic.bn_beqi, InstrClass.CondJump, r8, uimm32_13_3, disp0_8),
                Instr(Mnemonic.bn_bnei, InstrClass.CondJump, r8, uimm32_13_3, disp0_8),
                Instr(Mnemonic.bn_bgesi, InstrClass.CondJump, r8, uimm32_13_3, disp0_8),
                Instr(Mnemonic.bn_bgtsi, InstrClass.CondJump, r8, uimm32_13_3, disp0_8)
                ))),
            (0b010001, Widen24(WideSparse(16, 2, "  010001", nyi,
                ...
                (0b11, WideSparse(12, 4, "  11", nyi,
                    (0b0010, Instr(Mnemonic.bn_bf, InstrClass.CondJump, disp0_12)),
                    (0b0011, Instr(Mnemonic.bn_bnf, InstrClass.CondJump, disp0_12)),
                    (0b0100, Instr(Mnemonic.bn_bo, InstrClass.CondJump, disp0_12)),
                    (0b0101, Instr(Mnemonic.bn_bno, InstrClass.CondJump, disp0_12)),
                    (0b0110, Instr(Mnemonic.bn_bc, InstrClass.CondJump, disp0_12)),
                    (0b0111, Instr(Mnemonic.bn_bnc, InstrClass.CondJump, disp0_12)),
                    ...
                    (0b1101, WideMask(8, 2, "  01000111_1101",
                        Instr(Mnemonic.bn_return, InstrClass.Return),
                        Instr(Mnemonic.bn_jalr, InstrClass.CallInd, r3),
                        Instr(Mnemonic.bn_jr, InstrClass.JumpInd, r3),
                        nyi))))))),
            ...
            (0b101001, Widen48(WideSparse(38, 4, "  101000", nyi,
                ...
                (0b0000, Instr(Mnemonic.bw_jal, InstrClass.Call, disp0_32)),
                (0b0001, Instr(Mnemonic.bw_j, InstrClass.Jump, disp0_32)),
                (0b0010, Instr(Mnemonic.bw_bf, InstrClass.CondJump, disp0_32)),
                (0b0011, Instr(Mnemonic.bw_bnf, InstrClass.CondJump, disp0_32)),
                (0b0100, Instr(Mnemonic.bw_ja, InstrClass.Jump, abs0_32)),
                (0b0101, WideMask(32, 1, "  0110", 
                    Instr(Mnemonic.bw_jma, InstrClass.Jump, Mabs0_32),
                    Instr(Mnemonic.bw_jmal, InstrClass.Call, Mabs0_32))),
            ...
            (0b110100, Widen32(WideSparse(22, 4, "  110100", nyi,
                (0b0000, Instr(Mnemonic.bg_beqi, InstrClass.CondJump, r12, wsimm32_17_5, disp0_12)),
                (0b0001, Instr(Mnemonic.bg_bnei, InstrClass.CondJump, r12, wsimm32_17_5, disp0_12)),
                (0b0011, Instr(Mnemonic.bg_bgtsi, InstrClass.CondJump, r12, simm32_17_5, disp0_12)),
                (0b0100, Instr(Mnemonic.bg_bgeui, InstrClass.CondJump, r12, simm32_17_5, disp0_12)),
                (0b1000, Instr(Mnemonic.bg_bleui, InstrClass.CondJump, r12, simm32_17_5, disp0_12)),
                (0b1001, Instr(Mnemonic.bg_bltui, InstrClass.CondJump, r12, simm32_17_5, disp0_12)),
                (0b1010, Instr(Mnemonic.bg_beq, InstrClass.CondJump, r12, r12, disp0_12)),
                (0b1011, Instr(Mnemonic.bg_bne, InstrClass.CondJump, r12, r12, disp0_12)),
                (0b1100, Instr(Mnemonic.bg_bges, InstrClass.CondJump, r17, r12, disp0_12)),
                (0b1101, Instr(Mnemonic.bw_bgts, InstrClass.CondJump, r17, r12, disp0_12)),
                (0b1110, Instr(Mnemonic.bw_bgeu, InstrClass.CondJump, r17, r12, disp0_12)),
                (0b1111, Instr(Mnemonic.bw_bgtu, InstrClass.CondJump, r17, r12, disp0_12))))),
