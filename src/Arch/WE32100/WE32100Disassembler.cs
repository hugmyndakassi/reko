...
namespace Reko.Arch.WE32100
{
        ...
        */
        ...
        static WE32100Disassembler()
        {
            ...
            rootDecoder = Mask(0, 8, "WE32100", new Decoder[256] {
                ...
                Instr(Mnemonic.ret, InstrClass.Return, X("")),         // 0x08 Return from procedure
    ...
    //Instr(Mnemonic.Branch),         // on less than or equal byte(unsigned)
                ...
                // 0x60
                Instr(Mnemonic.rvc, InstrClass.CondReturn, X("")),         // 0x60 Return on overflow clear
                invalid,
                ...
                Instr(Mnemonic.rnequ, InstrClass.CondReturn, X("")),         // 0x64 Return on not equal(unsigned)
                invalid,
                ...
                Instr(Mnemonic.rvs, InstrClass.CondReturn, X("")),         // 0x68 Return on overflow set
                invalid,
                ...
                Instr(Mnemonic.reqlu, InstrClass.CondReturn, X("")),         // 0x6C Return on equal(unsigned)
                invalid,
                ...
                Instr(Mnemonic.rneq, InstrClass.CondReturn, X("")),         // 0x74 Return on not equal(signed)
                invalid,
                Instr(Mnemonic.bneh, X("")),         // 0x76 Branch on not equal halfword
                Instr(Mnemonic.bneb, X("")),         // 0x77 Branch on not equal

                Instr(Mnemonic.rsb, InstrClass.Return, X("")),         // 0x78 Return from subroutine
                invalid,
                ...
                Instr(Mnemonic.reql, InstrClass.CondReturn, X("")),         // 0x7C Return on equal(signed)
                invalid,
