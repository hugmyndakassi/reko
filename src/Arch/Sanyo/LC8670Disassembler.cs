    ...
    public class LC8670Disassembler : DisassemblerBase<LC8670Instruction, Mnemonic>
    {
        ...
        static LC8670Disassembler()
        {
            ...
            rootDecoders = new Decoder[]
            {
                ...
                Instr(Mnemonic.br, InstrClass.Jump, r8),
                ...
                Instr(Mnemonic.ld, Ri),
                Instr(Mnemonic.ld, Ri),
                Instr(Mnemonic.call, InstrClass.Call, a12),
                Instr(Mnemonic.call, InstrClass.Call, a12),
                Instr(Mnemonic.call, InstrClass.Call, a12),
                Instr(Mnemonic.call, InstrClass.Call, a12),
                Instr(Mnemonic.call, InstrClass.Call, a12),
                ...
                Instr(Mnemonic.callr, InstrClass.Call, r16),
                Instr(Mnemonic.brf, InstrClass.Jump, r16),
                ...
                Instr(Mnemonic.callf, InstrClass.Call, a16),
                Instr(Mnemonic.jmpf, InstrClass.Jump, a16),
                ...
                Instr(Mnemonic.mov, i8_Ri),
                Instr(Mnemonic.mov, i8_Ri),
                Instr(Mnemonic.jmp, InstrClass.Jump, a12),
                Instr(Mnemonic.jmp, InstrClass.Jump, a12),
                Instr(Mnemonic.jmp, InstrClass.Jump, a12),
                Instr(Mnemonic.jmp, InstrClass.Jump, a12),
                Instr(Mnemonic.jmp, InstrClass.Jump, a12),
                ...
                Instr(Mnemonic.mul),
                Instr(Mnemonic.be, InstrClass.CondJump, z),
                Instr(Mnemonic.be, InstrClass.CondJump, x),
                Instr(Mnemonic.be, InstrClass.CondJump, x),
                Instr(Mnemonic.be, InstrClass.CondJump, v),
                Instr(Mnemonic.be, InstrClass.CondJump, v),
                Instr(Mnemonic.be, InstrClass.CondJump, v),
                Instr(Mnemonic.be, InstrClass.CondJump, v),
                Instr(Mnemonic.jmp, InstrClass.Jump, a12),
                ...
                Instr(Mnemonic.div),
                Instr(Mnemonic.bne, InstrClass.CondJump, z),
                Instr(Mnemonic.bne, InstrClass.CondJump, x),
                Instr(Mnemonic.bne, InstrClass.CondJump, x),
                Instr(Mnemonic.bne, InstrClass.CondJump, v),
                Instr(Mnemonic.bne, InstrClass.CondJump, v),
                Instr(Mnemonic.bne, InstrClass.CondJump, v),
                Instr(Mnemonic.bne, InstrClass.CondJump, v),
                invalid,
                ...
                invalid,
                invalid,
                Instr(Mnemonic.dbnz, InstrClass.CondJump, x),
                Instr(Mnemonic.dbnz, InstrClass.CondJump, x),
                Instr(Mnemonic.dbnz, InstrClass.CondJump, c),
                Instr(Mnemonic.dbnz, InstrClass.CondJump, c),
                Instr(Mnemonic.dbnz, InstrClass.CondJump, c),
                Instr(Mnemonic.dbnz, InstrClass.CondJump, c),
                invalid,
                ...
                Instr(Mnemonic.inc, Ri),
                Instr(Mnemonic.inc, Ri),
                Instr(Mnemonic.bp, InstrClass.CondJump, r),
                Instr(Mnemonic.bp, InstrClass.CondJump, r),
                Instr(Mnemonic.bp, InstrClass.CondJump, r),
                Instr(Mnemonic.bp, InstrClass.CondJump, r),
                Instr(Mnemonic.bp, InstrClass.CondJump, r),
                ...
                Instr(Mnemonic.bz, InstrClass.CondJump, r8),
                ...
                Instr(Mnemonic.add, Ri),
                Instr(Mnemonic.add, Ri),
                Instr(Mnemonic.bn, InstrClass.CondJump, r),
                Instr(Mnemonic.bn, InstrClass.CondJump, r),
                Instr(Mnemonic.bn, InstrClass.CondJump, r),
                Instr(Mnemonic.bn, InstrClass.CondJump, r),
                Instr(Mnemonic.bn, InstrClass.CondJump, r),
                ...
                Instr(Mnemonic.bnz, InstrClass.CondJump, r8),
