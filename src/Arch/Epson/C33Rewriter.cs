...
public class C33Rewriter : IEnumerable<RtlInstructionCluster>
{
    ...
    public IEnumerator<RtlInstructionCluster> GetEnumerator()
    {
        while (dasm.MoveNext())
        {
            ...
            case Mnemonic.call: RewriteCall(instr, InstrClass.Call); break;
            case Mnemonic.call_d: RewriteCall(instr, InstrClass.CallD); break;
            ...
            case Mnemonic.jp: RewriteJp(instr, InstrClass.Jump); break;
            case Mnemonic.jpr: RewriteJpr(instr); break;
            case Mnemonic.jpr_d: RewriteJpr(instr); break;
            case Mnemonic.jp_d: RewriteJp(instr, InstrClass.JumpD); break;
