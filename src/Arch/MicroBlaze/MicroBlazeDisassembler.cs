        ...
        static MicroBlazeDisassembler()
        {
            ...
            rootDecoder = MaskBe(0, 6, "",
                ...
                SparseBe(11, 5, "0x26", invalid,
                    (0x00, Instr(Mnemonic.br, InstrClass.Jump, Rb)),
                    (0x08, Instr(Mnemonic.bra, InstrClass.Jump, Rb)),
                    (0x0C, Instr(Mnemonic.brk, InstrClass.CallD, Rd, Rb)),
                    (0x10, Instr(Mnemonic.brd, InstrClass.JumpD, Rb)),
                    (0x14, Instr(Mnemonic.brld, InstrClass.CallD, Rd, Rb)),
                    (0x18, Instr(Mnemonic.brad, InstrClass.JumpD, Rb)),
                    (0x1C, Instr(Mnemonic.brald, InstrClass.CallD, Rd, Rb))),
                Nyi("0x27"),
                ...
                SparseBe(6, 5, "0x2D", invalid,
                    (0x10, Instr(Mnemonic.rtsd, InstrClass.ReturnD, Ra,Is16)),
                    (0x11, Instr(Mnemonic.rtid, InstrClass.ReturnD, Ra,Iu16)),
                    (0x12, Instr(Mnemonic.rtbd, InstrClass.ReturnD, Ra,Iu16)),
                    (0x14, Instr(Mnemonic.rted, InstrClass.ReturnD, Ra,Iu16))),
                SparseBe(11, 5, "0x2E", invalid,
                    (0x00, Instr(Mnemonic.bri, InstrClass.Jump, Pc16)),
                    (0x08, Instr(Mnemonic.brai, InstrClass.Jump, Abs16)),
                    (0x0C, Instr(Mnemonic.brki, InstrClass.CallD, Rd, Abs16)),
                    (0x10, Instr(Mnemonic.brid, InstrClass.JumpD, Pc16)),
                    (0x14, Instr(Mnemonic.brlid, InstrClass.CallD, Rd, Pc16)),
                    (0x18, Instr(Mnemonic.braid, InstrClass.JumpD, Abs16)),
                    (0x1C, Instr(Mnemonic.bralid, InstrClass.CallD, Rd, Abs16))),
                SparseBe(6, 5, "  0x2F", invalid,
                    (0x00, Instr(Mnemonic.beqi, InstrClass.CondJump, Ra, Pc16)),
                    (0x01, Instr(Mnemonic.bnei, InstrClass.CondJump, Ra, Pc16)),
                    (0x02, Instr(Mnemonic.blti, InstrClass.CondJump, Ra, Pc16)),
                    (0x03, Instr(Mnemonic.blei, InstrClass.CondJump, Ra, Pc16)),
                    (0x04, Instr(Mnemonic.bgti, InstrClass.CondJump, Ra, Pc16)),
                    (0x05, Instr(Mnemonic.bgei, InstrClass.CondJump, Ra, Pc16)),

                    (0x10, Instr(Mnemonic.beqid, InstrClass.JCD, Ra, Pc16)),
                    (0x11, Instr(Mnemonic.bneid, InstrClass.JCD, Ra, Pc16)),
                    (0x12, Instr(Mnemonic.bltid, InstrClass.JCD, Ra, Pc16)),
                    (0x13, Instr(Mnemonic.bleid, InstrClass.JCD, Ra, Pc16)),
                    (0x14, Instr(Mnemonic.bgtid, InstrClass.JCD, Ra, Pc16)),
                    (0x15, Instr(Mnemonic.bgeid, InstrClass.JCD, Ra, Pc16))),
