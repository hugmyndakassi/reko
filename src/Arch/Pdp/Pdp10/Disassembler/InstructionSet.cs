        ...
        public class InstructionSet
        {
            ...
            public static Decoder Create()
            {
                ...
                var jfclVariants = Mask(acField, "  jfcl",
                    ...
                    Instr(Mnemonic.jfov, InstrClass.CondJump, J),
                    Instr(Mnemonic.jcry1, InstrClass.CondJump, J),
                    jfcl,

                    Instr(Mnemonic.jcry0, InstrClass.CondJump, J),
                    jfcl,
                    Instr(Mnemonic.jcry, InstrClass.CondJump, J),
                    jfcl,

                    Instr(Mnemonic.jov, InstrClass.CondJump, J),
                    jfcl,
                    jfcl,
                    jfcl,
                ...
                var jrstVariants = Mask(acField, "  jrst",
                    Instr(Mnemonic.jrst, InstrClass.Jump, J),
                    Instr(Mnemonic.portal),
                    Instr(Mnemonic.jrstf, InstrClass.Jump, J),
                    invalid,

                    Instr(Mnemonic.halt, InstrClass.Terminates, J),
                    Instr(Mnemonic.xjrstf, InstrClass.Jump, J),
                    Instr(Mnemonic.xjen, InstrClass.Jump, J),
                    Instr(Mnemonic.xpcw, InstrClass.Jump, J),

                    Nyi(Mnemonic.jrst),
                    invalid,
                    Instr(Mnemonic.jen, InstrClass.Jump, J),
                    invalid,

                    Instr(Mnemonic.sfm, InstrClass.Jump, J),
                    invalid,
                    invalid,
                    invalid);
                ...
                var opcodes2 = Mask(bf(3, 6), "  Integer arithmetic, jump to subroutine",
                    ...
                    Instr(Mnemonic.pushj, InstrClass.Call, AC,J),
                    Instr(Mnemonic.push, AC,E),
                    Instr(Mnemonic.pop, AC,E),
                    Instr(Mnemonic.popj, InstrClass.Return, AC,E),
                    Instr(Mnemonic.jsr, InstrClass.Jump, J),
                    Instr(Mnemonic.jsp, InstrClass.Jump, AC, J),
                ...
                var opcodes3 = Mask(bf(3, 6), "  Hop, skip, and jump", // codes 3_0 do not skip or jump
                    ...
                    Instr(Mnemonic.cail, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.caie, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.caile, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.caia, InstrClass.Jump, AC, E),
                    Instr(Mnemonic.caige, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.cain, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.caig, InstrClass.CondJump, AC, E),

                    Instr(Mnemonic.cam, InstrClass.Linear|InstrClass.Padding, ACnot0, E),
                    Instr(Mnemonic.caml, InstrClass.CondJump, ACnot0, E),
                    Instr(Mnemonic.came, InstrClass.CondJump, ACnot0, E),
                    Instr(Mnemonic.camle, InstrClass.CondJump, ACnot0, E),
                    Instr(Mnemonic.cama, InstrClass.Jump, ACnot0, E),
                    Instr(Mnemonic.camge, InstrClass.CondJump, ACnot0, E),
                    Instr(Mnemonic.camn, InstrClass.CondJump, ACnot0, E),
                    Instr(Mnemonic.camg, InstrClass.CondJump, ACnot0, E),

                    Instr(Mnemonic.jump, AC, J),
                    Instr(Mnemonic.jumpl, InstrClass.CondJump, AC, J),
                    Instr(Mnemonic.jumpe, InstrClass.CondJump, AC, J),
                    Instr(Mnemonic.jumple, InstrClass.CondJump, AC, J),
                    Instr(Mnemonic.jumpa, InstrClass.Jump, AC, J),
                    Instr(Mnemonic.jumpge, InstrClass.CondJump, AC, J),
                    Instr(Mnemonic.jumpn, InstrClass.CondJump, AC, J),
                    Instr(Mnemonic.jumpg, InstrClass.CondJump, AC, J),

                    Instr(Mnemonic.skip, ACnot0, E),
                    Instr(Mnemonic.skipl, InstrClass.CondJump, ACnot0, E),
                    Instr(Mnemonic.skipe, InstrClass.CondJump, ACnot0, E),
                    Instr(Mnemonic.skiple, InstrClass.CondJump, ACnot0, E),
                    Instr(Mnemonic.skipa, InstrClass.Jump, ACnot0, E),
                    Instr(Mnemonic.skipge, InstrClass.CondJump, ACnot0, E),
                    Instr(Mnemonic.skipn, InstrClass.CondJump, ACnot0, E),
                    Instr(Mnemonic.skipg, InstrClass.CondJump, ACnot0, E),

                    Instr(Mnemonic.aoj, AC, J),
                    Instr(Mnemonic.aojl, InstrClass.CondJump, AC, J),
                    Instr(Mnemonic.aoje, InstrClass.CondJump, AC, J),
                    Instr(Mnemonic.aojle, InstrClass.CondJump, AC, J),
                    Instr(Mnemonic.aoja, InstrClass.Jump, AC, J),
                    Instr(Mnemonic.aojge, InstrClass.CondJump, AC, J),
                    Instr(Mnemonic.aojn, InstrClass.CondJump, AC, J),
                    Instr(Mnemonic.aojg, InstrClass.CondJump, AC, J),

                    Instr(Mnemonic.aos, ACnot0, E),
                    Instr(Mnemonic.aosl, InstrClass.CondJump, ACnot0, E),
                    Instr(Mnemonic.aose, InstrClass.CondJump, ACnot0, E),
                    Instr(Mnemonic.aosle, InstrClass.CondJump, ACnot0, E),
                    Instr(Mnemonic.aosa, InstrClass.Jump, ACnot0, E),
                    Instr(Mnemonic.aosge, InstrClass.CondJump, ACnot0, E),
                    Instr(Mnemonic.aosn, InstrClass.CondJump, ACnot0, E),
                    Instr(Mnemonic.aosg, InstrClass.CondJump, ACnot0, E),

                    Instr(Mnemonic.soj, AC, J),
                    Instr(Mnemonic.sojl, InstrClass.CondJump, AC, J),
                    Instr(Mnemonic.soje, InstrClass.CondJump, AC, J),
                    Instr(Mnemonic.sojle, InstrClass.CondJump, AC, J),
                    Instr(Mnemonic.soja, InstrClass.Jump, AC, J),
                    Instr(Mnemonic.sojge, InstrClass.CondJump, AC, J),
                    Instr(Mnemonic.sojn, InstrClass.CondJump, AC, J),
                    Instr(Mnemonic.sojg, InstrClass.CondJump, AC, J),

                    Instr(Mnemonic.sos, ACnot0, E),
                    Instr(Mnemonic.sosl, InstrClass.CondJump, ACnot0, E),
                    Instr(Mnemonic.sose, InstrClass.CondJump, ACnot0, E),
                    Instr(Mnemonic.sosle, InstrClass.CondJump, ACnot0, E),
                    Instr(Mnemonic.sosa, InstrClass.Jump, ACnot0, E),
                    Instr(Mnemonic.sosge, InstrClass.CondJump, ACnot0, E),
                    Instr(Mnemonic.sosn, InstrClass.CondJump, ACnot0, E),
                    Instr(Mnemonic.sosg, InstrClass.CondJump, ACnot0, E));
                ...
                var opcodes6 = Mask(bf(3, 6), "  Test bits",
                    ...
                    Instr(Mnemonic.trne, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.tlne, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.trna, InstrClass.Jump, AC, E),
                    Instr(Mnemonic.tlna, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.trnn, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.tlnn, InstrClass.CondJump, AC, E),

                    Instr(Mnemonic.tdn, AC, E),
                    Instr(Mnemonic.tsn, AC, E),
                    Instr(Mnemonic.tdne, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.tsne, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.tdna, InstrClass.Jump, AC, E),
                    Instr(Mnemonic.tsna, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.tdnn, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.tsnn, InstrClass.CondJump, AC, E),

                    Instr(Mnemonic.trz, AC, E),
                    Instr(Mnemonic.tlz, AC, E),
                    Instr(Mnemonic.trze, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.tlze, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.trza, InstrClass.Jump, AC, E),
                    Instr(Mnemonic.tlza, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.trzn, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.tlzn, InstrClass.CondJump, AC, E),

                    Instr(Mnemonic.tdz, AC, E),
                    Instr(Mnemonic.tsz, AC, E),
                    Instr(Mnemonic.tdze, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.tsze, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.tdza, InstrClass.Jump, AC, E),
                    Instr(Mnemonic.tsza, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.tdzn, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.tszn, InstrClass.CondJump, AC, E),

                    Instr(Mnemonic.trc, AC, E),
                    Instr(Mnemonic.tlc, AC, E),
                    Instr(Mnemonic.trce, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.tlce, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.trca, InstrClass.Jump, AC, E),
                    Instr(Mnemonic.tlca, InstrClass.Jump, AC, E),
                    Instr(Mnemonic.trcn, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.tlcn, InstrClass.CondJump, AC, E),

                    Instr(Mnemonic.tdc, AC, E),
                    Instr(Mnemonic.tsc, AC, E),
                    Instr(Mnemonic.tdce, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.tsce, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.tdca, InstrClass.Jump, AC, E),
                    Instr(Mnemonic.tsca, InstrClass.Jump, AC, E),
                    Instr(Mnemonic.tdcn, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.tscn, InstrClass.CondJump, AC, E),

                    Instr(Mnemonic.tro, AC, E),
                    Instr(Mnemonic.tlo, AC, E),
                    Instr(Mnemonic.troe, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.tloe, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.troa, InstrClass.Jump, AC, E),
                    Instr(Mnemonic.tloa, InstrClass.Jump, AC, E),
                    Instr(Mnemonic.tron, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.tlon, InstrClass.CondJump, AC, E),

                    Instr(Mnemonic.tdo, AC, E),
                    Instr(Mnemonic.tso, AC, E),
                    Instr(Mnemonic.tdoe, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.tsoe, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.tdoa, InstrClass.Jump, AC, E),
                    Instr(Mnemonic.tsoa, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.tdon, InstrClass.CondJump, AC, E),
                    Instr(Mnemonic.tson, InstrClass.CondJump, AC, E));
